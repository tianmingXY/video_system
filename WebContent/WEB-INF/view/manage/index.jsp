    ...
    <div class="layui-side layui-bg-black">
        ...
        <div class="navBar">
            <ul class="layui-nav layui-nav-tree">
                ...
                <li class="layui-nav-item layui-nav-itemed">
                    <a href="javascript:;" data-url="${ctx}/manage/filminfoList">
                        <i class="layui-icon" data-icon=""></i>
                        <cite>视频管理</cite>
                    </a>
                </li>
                <li class="layui-nav-item layui-nav-itemed">
                    <a href="javascript:;" data-url="${ctx}/manage/danmuList">
                        <i class="layui-icon" data-icon=""></i>
                        <cite>弹幕内容管理</cite>
                    </a>
                </li>
                <li class="layui-nav-item layui-nav-itemed">
                    <a href="javascript:;" data-url="${ctx}/manage/vipcardList">
                        <i class="layui-icon" data-icon=""></i>
                        <cite>VIP充值卡管理</cite>
                    </a>
                </li>
...
<div id="showWelcomeMsgDiv" style="display: none;">
    欢迎${sessionScope.loginuserName}登录-弹幕视频网站-后台管理系统！
</div>
<!-- 移动导航 -->
