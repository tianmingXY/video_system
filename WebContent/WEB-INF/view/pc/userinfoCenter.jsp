                ...
                <c:if test="${isvip}">
                    <div class="layui-form-item ">
                        ...
                        <div class="layui-input-block" style="margin-top: 10px;">
                            <input type="text" name="ddd" lay-verify="required" disabled style="color: red;font-weight: bold;"
                                   placeholder="请输入密码"
                                   value='<fmt:formatDate value="${userinfo.viptime}"
