                        ...
                        <div class="layui-inline" style="text-align: left;">
                            ...
                            <div class="layui-input-inline">
                                <select name="orderStr" id="orderStr" class="layui-select">
                                    ...
                                    <option value=" sendyear asc ">年代升序</option>
                                    <option value=" sendyear desc ">年代降序</option>
                                </select>
                            </div>
                            <div class="layui-input-inline">
        ...
        <c:forEach items="${beanDataList}" var="item" varStatus="ss">
            <div class="layui-col-md4 layui-col-sm6">
                <div class="cmdlist-container">
                    <a href="${ctx}/pc/filminfoDetail?id=${item.id}">
                            <%--<img src="${fn:startsWith(item.picurl, 'http')?'':ctx}/${item.picurl}" style="width: 100%;">--%>
                        <img src="${item.picurl}" style="width: 100%;height: 300px;">
                    </a>
                    <a href="javascript:;">
                        <div class="cmdlist-text">
                            ...
                            <div class="price" style="margin-top: -18px;">
                                ...
                                <p>来源:${item.location}</p>
                                <span class="flow"><i class="layui-icon layui-icon-date"></i>
                                    ${item.sendyear}
                                </span>
                                <span class="flow"><i class="layui-icon layui-icon-video"></i>
                                    ${item.hits}
                                    &nbsp;&nbsp;&nbsp;&nbsp;
                                </span>
                            </div>
